...
mod tests {
    ...
    // Below example comes from:
    // https://raw.githubusercontent.com/spdx/spdx-examples/master/example9/spdx2.2/appbomination.spdx.json
    ...
    #[test]
    fn test_valid_slsa22_document() {
        let sbom = serde_json::from_str::<Spdx22Document>(SPDX_DOC).unwrap();
        assert_eq!(sbom.spdx_version.unwrap(), "SPDX-2.2");
    }
}
